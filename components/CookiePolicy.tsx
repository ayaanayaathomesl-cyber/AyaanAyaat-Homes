  ...
  return (
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-4xl mx-auto flex-grow w-full">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#002147] mb-8">Cookie Policy</h1>
        ...
        <div className="prose prose-lg prose-slate text-gray-600 space-y-6">
          ...
          <h2 className="text-2xl font-serif text-[#002147] mt-8 mb-4">1. What are Cookies?</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-[#002147] mt-8 mb-4">2. How We Use Cookies</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-[#002147] mt-8 mb-4">3. Your Choices</h2>
          <p>
