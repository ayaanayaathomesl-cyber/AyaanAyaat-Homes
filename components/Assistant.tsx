    ...
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-4 font-sans">
      ...
      <div className="flex items-center gap-3 group">
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="w-14 h-14 md:w-[60px] md:h-[60px] bg-[#25D366] rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.3)] flex items-center justify-center hover:scale-105 hover:shadow-[0_4px_25px_rgba(37,211,102,0.5)] transition-all active:scale-95 animate-float-mini"
          title="WhatsApp Us"
        >
          {/* White WhatsApp Icon */}
          <svg className="w-8 h-8 md:w-9 md:h-9 text-white fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
