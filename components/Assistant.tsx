      ...
      <div className="flex items-center gap-3 group">
        ...
        <div className="relative flex items-center justify-center">
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="w-12 h-12 md:w-14 md:h-14 bg-[#25D366] rounded-full shadow-[0_6px_16px_rgba(37,211,102,0.4)] flex items-center justify-center hover:scale-110 hover:shadow-[0_8px_20px_rgba(37,211,102,0.6)] transition-all duration-300 active:scale-95"
            title="WhatsApp Us"
          >
            {/* White WhatsApp Icon */}
            <svg className="w-6 h-6 md:w-8 md:h-8 text-white fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
