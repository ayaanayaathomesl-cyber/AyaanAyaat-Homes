  ...
  return (
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-4xl mx-auto flex-grow w-full relative">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl text-[#4a3426] mb-8">Terms of Service</h1>
        ...
        <div className="prose prose-lg prose-slate text-gray-600 space-y-6">
          ...
          <h2 className="text-2xl text-[#4a3426] mt-8 mb-4">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#4a3426] mt-8 mb-4">2. Hostel Rules & Regulations</h2>
          <p>
          ...
          <h2 className="text-2xl text-[#4a3426] mt-8 mb-4">3. Payments and Fees</h2>
          ...
          <h2 className="text-2xl text-[#4a3426] mt-8 mb-4">4. Limitation of Liability</h2>
          <p>
